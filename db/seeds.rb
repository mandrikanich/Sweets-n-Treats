...
Item.create(item_name: "double chocolate mint cookie", description: "fresh dark chocolate cookie with mint and choclate chips", price: 3)
Item.create(item_name: "red velet cupcake", description: "classic red velvet topped with buttercream frosting", price: 6)
Item.create(item_name: "lemon angel food cupcake", description: "light and airy and food cupcake topped with lemon whipped cream frosting", price: 6)
